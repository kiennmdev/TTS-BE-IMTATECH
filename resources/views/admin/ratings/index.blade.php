                    ...
                    <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle"
                        ...
                        @endphp
                            <tr>
                                <td>{{$id + 1}}</td>
                                <td>
                                    <img src="{{Storage::url($product->img_thumbnail)}}" alt="" width="80px">
                                </td>
                                <td>{{$product->name}}</td>
                                <td>{{$average}}</td>
                                <td>{{count($product->ratings)}}</td>
                                <td>
                                    <a href="{{route('admin.rating.detail', $product->id)}}" class="btn btn-sm btn-soft-info edit-item-btn"><i class="ri-edit-2-line"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </table>
